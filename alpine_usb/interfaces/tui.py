...
CHOICES = {
    ...
    "branch": ["latest-stable", "edge", "v3.22", "v3.21", "rolling", "stable"],
    "arch": ["x86_64"],
...
class TuiApp:
    ...
    def package_search_screen(self):
        ...
        try:
            if self.config["distro"] == "arch":
                results = cli.search_official_arch_packages(query, self.config["arch"], 10)
            else:
