...
class Main(QWidget):
    ...
    def build(self):
        ...
        img_buttons.setContentsMargins(0, 0, 0, 0)
        img_buttons.addStretch()
        img_buttons.addWidget(build)
        img_grid.addLayout(img_buttons, 1, 1, 1, 2)
        ...
        usb_buttons.setContentsMargins(58, 0, 0, 0)
        usb_buttons.setSpacing(6)
        usb_buttons.addWidget(pick)
        usb_buttons.addWidget(flash)
        usb_buttons.addStretch()
        usb_box.addLayout(usb_buttons)
        ...
        warn.setContentsMargins(58, -2, 0, 0)
