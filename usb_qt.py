...
class Main(QWidget):
    ...
    def build(self):
        ...
        usb_grid.setContentsMargins(0, 0, 0, 0)
        usb_grid.setColumnStretch(1, 1)
        usb_grid.setHorizontalSpacing(4)
        usb_grid.setVerticalSpacing(2)
        ...
        usb_grid.addWidget(device_label, 0, 0)
        ...
        usb_grid.addWidget(warn, 1, 1, 1, 3)
