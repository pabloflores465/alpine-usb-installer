...
class Main(QWidget):
    ...
    def build(self):
        ...
        select_usb_row = QHBoxLayout()
        select_usb_row.setContentsMargins(0, 6, 0, 0)
        select_usb_row.addWidget(pick)
        select_usb_row.addStretch()
        usb_box.addLayout(select_usb_row)
