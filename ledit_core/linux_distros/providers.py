...
DISTROS: dict[str, DistroProvider] = {
    ...
    "arch": DistroProvider(
        ...
        build_script="backend/scripts/build-arch-usb.sh",
        configure_script="backend/scripts/configure-arch-usb.sh",
        env_prefix="ARCH_USB",
    ...
    "debian": DistroProvider(
        ...
        build_script="backend/scripts/build-debian-usb.sh",
        configure_script="backend/scripts/configure-debian-usb.sh",
    ...
    "fedora": DistroProvider(
        ...
        build_script="backend/scripts/build-fedora-usb.sh",
    ...
    "gentoo": DistroProvider(
        ...
        build_script="backend/scripts/build-gentoo-usb.sh",
        configure_script="backend/scripts/configure-gentoo-usb.sh",
    ...
    "opensuse": DistroProvider(
        ...
        build_script="backend/scripts/build-opensuse-usb.sh",
        configure_script="backend/scripts/configure-opensuse-usb.sh",
    ...
    "rhel": DistroProvider(
        ...
        build_script="backend/scripts/build-rhel-usb.sh",
        configure_script="backend/scripts/configure-rhel-usb.sh",
        env_prefix="RHEL_USB",
    ...
    "slackware": DistroProvider(
        ...
        build_script="backend/scripts/build-slackware-usb.sh",
        configure_script="backend/scripts/configure-slackware-usb.sh",
