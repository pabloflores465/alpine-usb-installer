...
USER_NAME="${LEDIT_USB_USER:-gentoo}"
USER_PASSWORD="$(read_secret_value LEDIT_USB_PASSWORD_FILE LEDIT_USB_PASSWORD gentoo)"
ROOT_PASSWORD="$(read_secret_value LEDIT_USB_ROOT_PASSWORD_FILE LEDIT_USB_ROOT_PASSWORD "$USER_PASSWORD")"
HOSTNAME="${LEDIT_USB_HOSTNAME:-ledit-gentoo}"
