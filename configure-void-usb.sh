...
USER_NAME="${ALPINE_USB_USER:-void}"
USER_PASSWORD="$(read_secret_value ALPINE_USB_PASSWORD_FILE ALPINE_USB_PASSWORD void)"
ROOT_PASSWORD="$(read_secret_value ALPINE_USB_ROOT_PASSWORD_FILE ALPINE_USB_ROOT_PASSWORD "$USER_PASSWORD")"
HOSTNAME="${ALPINE_USB_HOSTNAME:-void-usb}"
...
EXTRA_PACKAGES="${ALPINE_USB_EXTRA_PACKAGES:-${VOID_USB_EXTRA_PACKAGES:-}}"
