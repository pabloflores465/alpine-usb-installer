...
def add_common_build_options(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--user", default="pablo")
    parser.add_argument("--password", default="pablo", help="Initial user password (use --ask-password to avoid shell history)")
    ...
    parser.add_argument("--console-keymap", default="la-latin1")
    parser.add_argument("--xkb-layout", default="latam")
