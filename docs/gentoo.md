...
This branch adds a real Gentoo provider and installed-image builder while preserving the Alpine backend.
...
```sh
./alpine-usb build --distro gentoo --branch stable --password gentoo \
